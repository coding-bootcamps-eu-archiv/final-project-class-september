<template>
  <main>
    <section class="table-item">
      <table class="table-item__table">
        <thead>
          <tr>
            <th class="table-item__table-head-name"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-file-code" viewBox="0 0 16 16">
  ...
  <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm10-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1z"/>
            ...
            <th class="type">
              ...
              <img class="CBE" src="https://image.jimcdn.com/app/cms/image/transf/dimension=230x10000:format=png/path/s0bc1816f4b388266/image/i2c7016bab2e2fa88/version/1647271231/image.png" alt="">
            </th>
            <th></th>
          </tr>
        </thead>
